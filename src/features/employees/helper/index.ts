...
import { Employee, EmployeePosition } from '@/types/api/employee';
import { PositionResource } from '@/types/api/get-position-resources';
import { base64ToFile } from '@/utils/file';

import { EmployeeFormValues } from '../components/form/schema';

export const transformPositionResourceData = (
  posRes: PositionResource[] = [],
) => {
...
export const makePositionMap = (posRes: PositionResource[] = []) => {
...
export const mappingFormValuesToEntity = (
...
export const mappingEmployeeDataToFormValues = (
  employee: Employee,
): EmployeeFormValues => {
...
export const getAllImages = (positions: EmployeePosition[]): File[] => {
